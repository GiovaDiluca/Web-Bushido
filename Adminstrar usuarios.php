...
include 'conexion_be.php'; // Asegúrate de que este archivo contenga la clase Database
...
try {
    ...
    $stmt = $pdo->prepare("SELECT id, nombre_completo, correo, telefono FROM usuarios"); // Cambia 'usuarios' por el nombre de tu tabla
    $stmt->execute();
